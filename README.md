...
6. Run `go get github.com/KaoNinjaratzu/outrun` and wait until the command line returns
7. Run `go build github.com/KaoNinjaratzu/outrun` and wait until the build is complete
