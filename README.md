...
6. Run `go get github.com/ToadRoasted/outrun` and wait until the command line returns
7. Run `go build github.com/ToadRoasted/outrun` and wait until the build is complete
